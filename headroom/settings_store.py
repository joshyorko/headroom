...
SETTINGS: tuple[SettingField, ...] = (
    ...
    SettingField(
        ...
        help="Memory storage backend. qdrant-neo4j uses external services.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_NEO4J_URI",
        ...
        help="Neo4j endpoint for the qdrant-neo4j backend.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_NEO4J_USER",
        ...
        "str",
        default="neo4j",
        help="Neo4j username for the qdrant-neo4j backend.",
        tier="advanced",
    ),
    SettingField(
        ...
        "str",
        default=None,
        help="Neo4j password for the qdrant-neo4j backend.",
        secret=True,
        tier="advanced",
    ),
    SettingField(
